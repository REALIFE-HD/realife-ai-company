      ...
      <div className="w-full max-w-md">
        <Link to="/" className="flex items-center justify-center gap-2.5 mb-8">
          ...
          <span className="flex flex-col leading-none">
            <span className="font-display text-base font-semibold tracking-wide text-foreground">REALIFE</span>
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          ...
          <button
            ...
            className="mt-5 flex w-full items-center justify-center gap-2.5 rounded-md border border-border bg-card px-4 py-2.5 text-sm font-medium text-muted-foreground hover:bg-muted disabled:opacity-60"
          >
          ...
          <div className="my-4 flex items-center gap-3">
            ...
            <span className="text-[10px] uppercase tracking-wider text-muted-foreground">または</span>
            <div className="h-px flex-1 bg-muted" />
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            {mode === "signup" && (
              <div>
                <label className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">表示名</label>
                <input
                  type="text"
                  value={displayName}
            ...
            <div>
              <label className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">メールアドレス</label>
              <input
                type="email"
                required
                value={email}
            ...
            <div>
              <label className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">パスワード</label>
              <input
                type="password"
                required
                minLength={6}
