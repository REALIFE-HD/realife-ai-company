...
export function DepartmentsGrid() {
  return (
    <section id="departments" className="border-b border-neutral-200 bg-neutral-50/40">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
          ...
          <a
            href="#"
            className="inline-flex items-center gap-1.5 text-sm font-medium text-neutral-800 transition-colors hover:text-neutral-950"
          >
            全部門を表示
