...
export function DepartmentCard({ d }: { d: Department }) {
  return (
    <Link
      ...
      className="group relative flex flex-col rounded-xl border border-slate-200 bg-white p-5 shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-all duration-200 hover:-translate-y-0.5 hover:border-teal-300 hover:shadow-[0_18px_32px_-18px_rgba(13,148,136,0.25)] focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:outline-none"
    >
